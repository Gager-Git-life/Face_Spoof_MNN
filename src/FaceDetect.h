...
class FaceDetect {
public:
	FaceDetect(const string& proto_model_dir, int num_thread_, float threhold_p=0.7f, float threhold_r=0.8f, float threhold_o = 0.8f, float factor = 0.709f);
